...
Route::post('posts/{post}/favorite', [PlaceController::class, 'favorite'])->middleware('auth:sanctum');
Route::delete('posts/{post}/favorite', [PlaceController::class, 'favorite'])->middleware('auth:sanctum');
